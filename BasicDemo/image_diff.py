...
def process_and_display_difference_images(partial_image, matched_region, threshold=60):
    try:
        ...
        for contour in contours:
            ...
            if area > 50:
                ...
                elif x - (cv2.boundingRect(current_contour)[0] + cv2.boundingRect(current_contour)[2]) < 100:
                    # 如果相邻，则合并两个轮廓
