...
# 读取要搜索的图像
search_image = cv2.imread('cuts/cut1.jpg', cv2.IMREAD_GRAYSCALE)

# 读取模板图像
template_image = cv2.imread('cuts/cut3.jpg', cv2.IMREAD_GRAYSCALE)
...
# 使用模板匹配函数
result = cv2.matchTemplate(search_image_bin, template_image_bin, cv2.TM_CCORR_NORMED)
threshold = 0.7
# 获取匹配度高于阈值的位置
